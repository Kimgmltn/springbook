...
public class PointcutExpressionTest {
    ...
    public void pointcut() throws Exception{
        targetClassPointcutMatches("execution(* *(..))", true, true, false, false, false, false);
        targetClassPointcutMatches("execution(* hello(..))", true, false, false, false, false, false);
        targetClassPointcutMatches("execution(* hello())", false, true, false, false, false, false);
        targetClassPointcutMatches("execution(* hello(String))", false, false, false, false, true, true);
        targetClassPointcutMatches("execution(* meth*(..))", false, false, true, true, false, false);
        targetClassPointcutMatches("execution(* *(int, int))", true, false, false, false, true, true);
    ...
    public void targetClassPointcutMatches(String expression, boolean... expected) throws Exception{
        ...
        pointcutMatches(expression, expected[3], Target.class, "minus");
